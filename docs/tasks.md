...
- [ ] Definir si el fixture documental (PDF + registro en `documents`/storage) se creara por script E2E (recomendado) o se mantendra manualmente en entorno local/staging.
