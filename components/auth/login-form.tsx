    ...
    <form className="space-y-4" action={action}>
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          autoComplete="email"
          required
          className="w-full rounded-md border border-slate-200 bg-slate-50/80 px-3.5 py-2.5 text-sm text-slate-900 outline-none placeholder:text-slate-400 focus:border-slate-300 focus:bg-white focus:ring-4 focus:ring-slate-200"
